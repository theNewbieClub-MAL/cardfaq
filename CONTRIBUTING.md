# Contributing to `cardfaq`

Hello and thanks for taking your time to contribute!

The following is a set of guidelines for contributing to `cardfaq`. These are mostly
...
1. Navigate back to the repository root
   ([`theNewbieClub-MAL/cardfaq`](https://github.com/theNewbieClub-MAL/cardfaq)).
...
```sh
git clone https://github.com/<YOUR USERNAME>/cardfaq
```
...
[GitHub Issue](https://github.com/theNewbieClub-MAL/cardfaq/issues). It helps users
...
<ol>
  <li>Open
    <a href="https://github.com/theNewbieClub-MAL/cardfaq/issues">
      theNewbieClub-MAL/cardfaq/issues
...
<ol>
  <li>Click <a href="https://github.com/theNewbieClub-MAL/cardfaq/issues">
      theNewbieClub-MAL/cardfaq/issues
    </a> and tap on New Issue button.</li>
  <li>In title bar, write:
